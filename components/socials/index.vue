<template>
          <div class="header__socials flex --align-center">
        <a target="_blank" href="https://github.com/RomanovMichael" class="header__social">
          <svg
            stroke="currentColor"
            fill="currentColor"
            stroke-width="0"
        ...
        <a target="_blank" href="https://vk.com/id143368521" class="header__social">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="currentColor"
            fill="currentColor"
        ...
        <a target="_blank" href="https://t.me/misha_romanov" class="header__social">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="currentColor"
            fill="currentColor"
...
<style src="~/components/socials/__socials.css" lang="css"></style>